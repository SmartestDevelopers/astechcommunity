...
<!-- Mirrored from creativelayers.net/themes/educrat-html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 Aug 2025 18:27:18 GMT -->
<head>
  <!-- Required meta tags -->
  <meta charset="UTF-8">
  ...
  <link rel="stylesheet" href="<?php echo e(asset('template/cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css')); ?>" integrity="sha512-1ycn6IcaQQ40/MKBW2W4Rhis/DbILU74C1vSrLJxCq57o941Ym01SwNsOMqvEBFlcgUa6xLiPY/NS5R+E6ztJQ==" crossorigin="anonymous" referrerpolicy="no-referrer" />
  <link rel="stylesheet" href="<?php echo e(asset('template/unpkg.com/leaflet%401.7.1/dist/leaflet.css')); ?>" integrity="sha512-xodZBNTC5n17Xt2atTPuE1HxjVMSvLVW9ocqUKLsCC5CXdbqCmblAshOMAS6/keqq/sMZMZ19scR4PsZChSR7A==" crossorigin="" />

  <!-- Stylesheets -->
  <link rel="stylesheet" href="<?php echo e(asset('template/css/vendors.css')); ?>">
            ...
            <div class="header-left">
              ...
              <div class="header__logo ">
                <a data-barba href="index.html">
                  <img src="<?php echo e(asset('template/img/general/logo.svg')); ?>" alt="logo">
                </a>
              </div>
                      ...
                      <div class="container">
                        <div class="header-search__field">
                          ...
                          <button class="d-flex items-center justify-center size-40 rounded-full bg-purple-3" data-el-toggle=".js-search-toggle">
                            <img src="<?php echo e(asset('template/img/menus/close.svg')); ?>" alt="icon">
                          </button>
                        </div>
                      ...
                      <div class="px-30 pt-30 pb-10">
                        ...
                        <div class="row justify-between x-gap-40 pb-20">
                          <div class="col">
                            <div class="row x-gap-10 y-gap-10">
                              <div class="col-auto">
                                <img src="<?php echo e(asset('template/img/menus/cart/1.png')); ?>" alt="image">
                              </div>
                          ...
                          <div class="col-auto">
                            <button><img src="<?php echo e(asset('template/img/menus/close.svg')); ?>" alt="icon"></button>
                          </div>
                        </div>
                        ...
                        <div class="row justify-between x-gap-40 pb-20">
                          <div class="col">
                            <div class="row x-gap-10 y-gap-10">
                              <div class="col-auto">
                                <img src="<?php echo e(asset('template/img/menus/cart/2.png')); ?>" alt="image">
                              </div>
            ...
            <div class="row y-gap-20 justify-between items-center">
              <div class="col-auto">
                <div class="footer-header__logo">
                  <img src="<?php echo e(asset('template/img/footer/footer-logo.svg')); ?>" alt="logo">
                </div>
              </div>
              <div class="col-auto">
...
<script src="<?php echo e(asset('template/js/vendors.js')); ?>"></script>
<script src="<?php echo e(asset('template/js/main.js')); ?>"></script>
</script>
</body>


<!-- Mirrored from creativelayers.net/themes/educrat-html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 Aug 2025 18:27:26 GMT -->
</html><?php /**PATH C:\Users\TOSHIBA\Documents\GitHub\astechcommunity\astech\resources\views/layouts/front.blade.php ENDPATH**/ ?>