 ...
 <div class="content-wrapper  js-content-wrapper">
      ...
      <section class="masthead -type-1 js-mouse-move-container">
        <div class="masthead__bg">
          <img src="<?php echo e(asset('template/img/home-1/hero/bg.png')); ?>" alt="image">
        </div>
            ...
            <div class="col-xl-6 col-lg-6 col-sm-10">
              <div class="masthead__content">
                <h1 data-anim-child="slide-up" class="masthead__title">
                  ...
                  with Top <span class="text-green-1 underline">Educators</span>
                </h1>
                ...
                <div data-anim-child="slide-up delay-3" class="masthead-info row y-gap-15 sm:d-none">
                  ...
                  <div class="masthead-info__item d-flex items-center text-white">
                    <div class="masthead-info__icon mr-10">
                      <img src="<?php echo e(asset('template/img/masthead/icons/1.svg')); ?>" alt="icon">
                    </div>
                  ...
                  <div class="masthead-info__item d-flex items-center text-white">
                    <div class="masthead-info__icon mr-10">
                      <img src="<?php echo e(asset('template/img/masthead/icons/2.svg')); ?>" alt="icon">
                    </div>
                  ...
                  <div class="masthead-info__item d-flex items-center text-white">
                    <div class="masthead-info__icon mr-10">
                      <img src="<?php echo e(asset('template/img/masthead/icons/3.svg')); ?>" alt="icon">
                    </div>
            ...
            <div data-anim-child="slide-up delay-5" class="col-xl-6 col-lg-6">
              <div class="masthead-image">
                <div class="masthead-image__el1">
                  <img class="js-mouse-move" data-move="40" src="<?php echo e(asset('template/img/masthead/1.png')); ?>" alt="image">
                  ...
                  <div data-move="30" class="lg:d-none img-el -w-250 px-20 py-20 d-flex items-center bg-white rounded-8 js-mouse-move">
                    <div class="size-50 d-flex justify-center items-center bg-red-2 rounded-full">
                      <img src="<?php echo e(asset('template/img/masthead/1.svg')); ?>" alt="icon">
                    </div>
                    <div class="ml-20">
                ...
                <div class="masthead-image__el2">
                  <img class="js-mouse-move" data-move="70" src="<?php echo e(asset('template/img/masthead/2.png')); ?>" alt="image">

                  <div data-move="60" class="lg:d-none img-el -w-260 px-20 py-20 d-flex items-center bg-white rounded-8 js-mouse-move">
                    <img src="<?php echo e(asset('template/img/masthead/4.png')); ?>" alt="icon">
                    <div class="ml-20">
                ...
                <div class="masthead-image__el3">
                  <img class="js-mouse-move" data-move="40" src="<?php echo e(asset('template/img/masthead/3.png')); ?>" alt="image">
                  ...
                  <div data-move="30" class="shadow-4 img-el -w-260 px-30 py-20 d-flex items-center bg-white rounded-8 js-mouse-move">
                    <div class="img-el__side">
                      <div class="size-50 d-flex justify-center items-center bg-purple-1 rounded-full">
                        <img src="<?php echo e(asset('template/img/masthead/2.svg')); ?>" alt="icon">
                      </div>
                    </div>
                    <div class="">
          ...
          <div class="row y-gap-30 justify-between sm:justify-start items-center pt-60 md:pt-50">
            ...
            <div data-anim-child="slide-up delay-1" class="col-lg-auto col-md-3 col-sm-4 col-6">
              <div class="d-flex justify-center items-center px-4">
                <img class="w-1/1" src="<?php echo e(asset('template/img/clients/1.svg')); ?>" alt="clients image">
              </div>
            </div>

            <div data-anim-child="slide-up delay-1" class="col-lg-auto col-md-3 col-sm-4 col-6">
              <div class="d-flex justify-center items-center px-4">
                <img class="w-1/1" src="<?php echo e(asset('template/img/clients/2.svg')); ?>" alt="clients image">
              </div>
            </div>

            <div data-anim-child="slide-up delay-1" class="col-lg-auto col-md-3 col-sm-4 col-6">
              <div class="d-flex justify-center items-center px-4">
                <img class="w-1/1" src="<?php echo e(asset('template/img/clients/3.svg')); ?>" alt="clients image">
              </div>
            </div>

            <div data-anim-child="slide-up delay-1" class="col-lg-auto col-md-3 col-sm-4 col-6">
              <div class="d-flex justify-center items-center px-4">
                <img class="w-1/1" src="<?php echo e(asset('template/img/clients/4.svg')); ?>" alt="clients image">
              </div>
            </div>

            <div data-anim-child="slide-up delay-1" class="col-lg-auto col-md-3 col-sm-4 col-6">
              <div class="d-flex justify-center items-center px-4">
                <img class="w-1/1" src="<?php echo e(asset('template/img/clients/5.svg')); ?>" alt="clients image">
              </div>
            </div>

            <div data-anim-child="slide-up delay-1" class="col-lg-auto col-md-3 col-sm-4 col-6">
              <div class="d-flex justify-center items-center px-4">
                <img class="w-1/1" src="<?php echo e(asset('template/img/clients/6.svg')); ?>" alt="clients image">
              </div>
            </div>
            ...
            <div class="swiper-wrapper">
                ...
                <div data-anim-child="slide-left delay-2" class="featureCard -type-1 -featureCard-hover">
                  <div class="featureCard__content">
                    <div class="featureCard__icon">
                      <img src="<?php echo e(asset('template/img/featureCards/1.svg')); ?>" alt="icon">
                    </div>
              ...
              <div class="swiper-slide">
                <div data-anim-child="slide-left delay-3" class="featureCard -type-1 -featureCard-hover">
                  <div class="featureCard__content">
                    <div class="featureCard__icon">
                      <img src="<?php echo e(asset('template/img/featureCards/2.svg')); ?>" alt="icon">
                    </div>
              ...
              <div class="swiper-slide">
                <div data-anim-child="slide-left delay-4" class="featureCard -type-1 -featureCard-hover">
                  <div class="featureCard__content">
                    <div class="featureCard__icon">
                      <img src="<?php echo e(asset('template/img/featureCards/3.svg')); ?>" alt="icon">
                    </div>
              ...
              <div class="swiper-slide">
                <div data-anim-child="slide-left delay-5" class="featureCard -type-1 -featureCard-hover">
                  <div class="featureCard__content">
                    <div class="featureCard__icon">
                      <img src="<?php echo e(asset('template/img/featureCards/4.svg')); ?>" alt="icon">
                    </div>
              ...
              <div class="swiper-slide">
                <div data-anim-child="slide-left delay-6" class="featureCard -type-1 -featureCard-hover">
                  <div class="featureCard__content">
                    <div class="featureCard__icon">
                      <img src="<?php echo e(asset('template/img/featureCards/5.svg')); ?>" alt="icon">
                    </div>
              ...
              <div class="swiper-slide">
                <div data-anim-child="slide-left delay-7" class="featureCard -type-1 -featureCard-hover">
                  <div class="featureCard__content">
                    <div class="featureCard__icon">
                      <img src="<?php echo e(asset('template/img/featureCards/6.svg')); ?>" alt="icon">
                    </div>
                      ...
                      <a href="courses-single-1.html" class="coursesCard -type-1 ">
                        <div class="relative">
                          <div class="coursesCard__image overflow-hidden rounded-8">
                            <img class="w-1/1" src="<?php echo e(asset('template/img/coursesCards/1.png')); ?>" alt="image">
                        ...
                        <div class="h-100 pt-15">
                          ...
                          <div class="d-flex x-gap-10 items-center pt-10">
                            ...
                            <div class="d-flex items-center">
                              <div class="mr-8">
                                <img src="<?php echo e(asset('template/img/coursesCards/icons/1.svg')); ?>" alt="icon">
                              </div>
                            ...
                            <div class="d-flex items-center">
                              <div class="mr-8">
                                <img src="<?php echo e(asset('template/img/coursesCards/icons/2.svg')); ?>" alt="icon">
                              </div>
                            ...
                            <div class="d-flex items-center">
                              <div class="mr-8">
                                <img src="<?php echo e(asset('template/img/coursesCards/icons/3.svg')); ?>" alt="icon">
                              </div>
                          ...
                          <div class="coursesCard-footer">
                            <div class="coursesCard-footer__author">
                              <img src="<?php echo e(asset('template/img/general/avatar-1.png')); ?>" alt="image">
                              <div>Ali Tufan</div>
                            </div>
                  ...
                  <div class="col-lg-3 col-md-6">
                    <div data-anim-child="slide-up delay-2">
                      ...
                      <a href="courses-single-1.html" class="coursesCard -type-1 ">
                        <div class="relative">
                          <div class="coursesCard__image overflow-hidden rounded-8">
                            <img class="w-1/1" src="<?php echo e(asset('template/img/coursesCards/2.png')); ?>" alt="image">
                            <div class="coursesCard__image_overlay rounded-8"></div>
                          </div>
                          <div class="d-flex justify-between py-10 px-10 absolute-full-center z-3">
                  ...
                  <div class="col-lg-3 col-md-6">
                    <div data-anim-child="slide-up delay-3">
                      ...
                      <a href="courses-single-1.html" class="coursesCard -type-1 ">
                        <div class="relative">
                          <div class="coursesCard__image overflow-hidden rounded-8">
                            <img class="w-1/1" src="<?php echo e(asset('template/img/coursesCards/3.png')); ?>" alt="image">
                            <div class="coursesCard__image_overlay rounded-8"></div>
                          </div>
                          <div class="d-flex justify-between py-10 px-10 absolute-full-center z-3">
                  ...
                  <div class="col-lg-3 col-md-6">
                    <div data-anim-child="slide-up delay-4">
                      ...
                      <a href="courses-single-1.html" class="coursesCard -type-1 ">
                        <div class="relative">
                          <div class="coursesCard__image overflow-hidden rounded-8">
                            <img class="w-1/1" src="<?php echo e(asset('template/img/coursesCards/4.png')); ?>" alt="image">
                            <div class="coursesCard__image_overlay rounded-8"></div>
                          </div>
                          <div class="d-flex justify-between py-10 px-10 absolute-full-center z-3">
                  ...
                  <div class="col-lg-3 col-md-6">
                    <div data-anim-child="slide-up delay-5">
                      ...
                      <a href="courses-single-1.html" class="coursesCard -type-1 ">
                        <div class="relative">
                          <div class="coursesCard__image overflow-hidden rounded-8">
                            <img class="w-1/1" src="<?php echo e(asset('template/img/coursesCards/5.png')); ?>" alt="image">
                            <div class="coursesCard__image_overlay rounded-8"></div>
                          </div>
                          <div class="d-flex justify-between py-10 px-10 absolute-full-center z-3">
                  ...
                  <div class="col-lg-3 col-md-6">
                    <div data-anim-child="slide-up delay-6">
                      ...
                      <a href="courses-single-1.html" class="coursesCard -type-1 ">
                        <div class="relative">
                          <div class="coursesCard__image overflow-hidden rounded-8">
                            <img class="w-1/1" src="<?php echo e(asset('template/img/coursesCards/6.png')); ?>" alt="image">
                            <div class="coursesCard__image_overlay rounded-8"></div>
                          </div>
                          <div class="d-flex justify-between py-10 px-10 absolute-full-center z-3">
                  ...
                  <div class="col-lg-3 col-md-6">
                    <div data-anim-child="slide-up delay-7">
                      ...
                      <a href="courses-single-1.html" class="coursesCard -type-1 ">
                        <div class="relative">
                          <div class="coursesCard__image overflow-hidden rounded-8">
                            <img class="w-1/1" src="<?php echo e(asset('template/img/coursesCards/7.png')); ?>" alt="image">
                            <div class="coursesCard__image_overlay rounded-8"></div>
                          </div>
                          <div class="d-flex justify-between py-10 px-10 absolute-full-center z-3">
                  ...
                  <div class="col-lg-3 col-md-6">
                    <div data-anim-child="slide-up delay-8">
                      ...
                      <a href="courses-single-1.html" class="coursesCard -type-1 ">
                        <div class="relative">
                          <div class="coursesCard__image overflow-hidden rounded-8">
                            <img class="w-1/1" src="<?php echo e(asset('template/img/coursesCards/8.png')); ?>" alt="image">
                            <div class="coursesCard__image_overlay rounded-8"></div>
                          </div>
                          <div class="d-flex justify-between py-10 px-10 absolute-full-center z-3">
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\TOSHIBA\Documents\GitHub\astechcommunity\astech\resources\views/home.blade.php ENDPATH**/ ?>